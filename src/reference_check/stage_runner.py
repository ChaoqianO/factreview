...
from reference_check.refcheck import check_references, format_reference_check_markdown  # noqa: E402


def run_reference_check_stage(
    *,
    repo_root: Path,
    run_dir: Path,
    ...
    ensure_full_pipeline_context(run_dir=run_dir, allow_standalone=True, stage="reference_check")
    ...
    stage_dir = run_dir / "stages" / "reference_check"
